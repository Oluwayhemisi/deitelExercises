...
public class Atm {
    ...
    private static void checkBalance() {
        ...
        MyAccount account = zuBank.findAccount(Integer.parseInt(accountNumber));
    ...
    private static void sendUrgent2k() {
        ...
        MyAccount fromAccount = zuBank.findAccount(Integer.parseInt(senderAccountNumber));
    ...
    private static void createAccount() {
        ...
        MyAccount savedAccount = zuBank.createAccountFor(firstName, lastName, pin);
